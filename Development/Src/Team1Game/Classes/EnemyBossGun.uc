 ...
 */
//modified 
class EnemyBossGun extends UTBeamWeapon;
...
var array<EnemyBossGun> LinkedList;	// I made a funny Hahahahah :)
...
function GetLinkedWeapons(out array<EnemyBossGun> LinkedWeapons)
{
	local int i;
...
{
	local array<EnemyBossGun> LinkedWeapons;
...
defaultproperties
{
	...
	FireInterval(0)=0.25//+0.24
	FireInterval(1)=6.00//+0.35

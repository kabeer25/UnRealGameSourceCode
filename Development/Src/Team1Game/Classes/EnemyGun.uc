 ...
 */
//modified 
class EnemyGun extends UTBeamWeapon;
...
var array<EnemyGun> LinkedList;	// I made a funny Hahahahah :)
...
function GetLinkedWeapons(out array<EnemyGun> LinkedWeapons)
{
	local int i;
...
{
	local array<EnemyGun> LinkedWeapons;
...
defaultproperties
{
	...
	FireInterval(0)=0.85//+0.24
	FireInterval(1)=10.02//+0.35
